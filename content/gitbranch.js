...
(function () {
    ...
    // THIS IS THE MONEY SHOT. We want to set the current branchy state here.
    this.CurrentViewChanged = function() {
        StatusbarElement.innerHTML = "derp";
        log.debug("The current view has changed.");
    }
    // this shows on overall window focus
    this.FocusEvent = function() {
        log.debug("A focus event has fired");
    }
